package com.distribuidora.ModuloFornecedor.service;
...
public class FornecedorService {
    ...
    public void deletar(String cnpj) {
        Fornecedor fornecedor = repository.findByCnpj(cnpj).orElseThrow(() -> new RuntimeException("Fornecedor não encontrado"));
